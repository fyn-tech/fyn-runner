...
class TestJob:
    ...
    def test_launch_exception(self, mock_job_info_runner, mock_server_proxy, mock_file_manager, mock_logger,
                  mock_active_job_tracker):
