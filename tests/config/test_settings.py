...
from fyn_runner.config.settings import Settings, State, LocalCache, APISettings, load, save
...
def test_partial_settings(temp_config_path):
    ...
    assert settings.api_settings.base_url == 'https:api.fyn-tech.com'  # Default preserved